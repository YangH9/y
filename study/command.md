...
1. Command-A: 全选各项。
2. Command-B: 以粗体显示所选文本，或者打开或关闭粗体显示功能。 
...
9. Command-I: 显示所选文件的“显示简介”窗口。以斜体显示所选文本，或者打开或关闭斜体显示功能。
10. Command-J: 
11. Command-K: 添加网页链接。
12. Command-L: 
...
19. Command-S: 存储当前文稿。
20. Command-T: 打开新标签页。在当前“访达”窗口中有单个标签页开着的状态下显示或隐藏标签页栏。显示或隐藏“字体”窗口。
21. Command-U: 对所选文本加下划线，或者打开或关闭加下划线功能。
