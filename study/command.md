...
* **msconfig**: 系统配置实用程序（工具选项卡里面可以查看一些命令的使用）
* **magnify**: 放大镜实用程序
* **secpol.msc**: 本地安全策略
* **utilman**: 轻松访问
...
* **Windows徽标键+A**: 打开通知
* **Windows徽标键+B**: 显示隐藏的状态栏图标
* **Windows徽标键+C**: 打开Cortana（语音助手）
* **Windows徽标键+D**: 显示桌面
...
* **Windows徽标键+R**: 打开运行
* **Windows徽标键+S**: 打开搜索
* **Windows徽标键+T**: 光标切换至任务栏
* **Windows徽标键+U**: 打开显示设置
* **Windows徽标键+V**: 打开剪切板记录
* **Windows徽标键+W**: 打开截屏
* **Windows徽标键+X**: 打开开始右键菜单
* **Windows徽标键+Y**: （无）
* **Windows徽标键+Z**: （无）
* **Windows徽标键+Tab**: 打开任务视图
* **Windows徽标键+(1~0)**: 打开或切换到任务栏对应应用
* **Windows徽标键+(+,-)**: 打开关闭放大镜
* **Windows徽标键+(↑,→,↓,←)**: 切换显示缩放状态位置
* **Windows徽标键+F1**: 帮助
* **Windows徽标键+F6**: 光标在任务栏切换
* **Windows徽标键+Ctrl+D**: 新建桌面
* **Windows徽标键+Ctrl+M**: 打开放大镜设置
* **Windows徽标键+Ctrl+N**: 打开讲述人设置
* **Windows徽标键+Ctrl+O**: 打开屏幕键盘
* **Windows徽标键+Ctrl+Q**: 打开快速助手
* **Windows徽标键+空格**: 打开切换输入法
...
* **Ctrl+Shift+W**: 关闭当前窗口
* **Ctrl+Shift+Tab**: 打开应用内的页面切换
* **Alt+Tab**: 在打开的应用之间切换

[Windows的键盘快捷方式](https://support.microsoft.com/zh-cn/help/12445/windows-keyboard-shortcuts)
...
[Mac的键盘快捷方式](https://support.apple.com/zh-cn/HT201236)